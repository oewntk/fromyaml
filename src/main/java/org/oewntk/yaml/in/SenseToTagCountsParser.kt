 ...
 */
class SenseToTagCountsParser(dir: File, val fileext: String = "yaml", verbose: Boolean = false) : YamlProcessor1<Pair<String, TagCount>, String, Map<String, Int>>(dir, verbose = verbose) {
